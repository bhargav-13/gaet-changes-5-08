        ...
        <div className='slider-style-two-section'>
          ...
          >
            {slides.map((slide, index) => (
              <SwiperSlide key={index}>
                <div className="row align-items-start gx-4 gy-3">
                  ...
                  <div className="col-lg-5 d-flex flex-lg-column">
                    <div className="container">
                      <div className="row">
                        <div className="col-md-6 col-sm-6 col-lg-12">
                          <p className="text-light image-description mt-5">{slide.description}</p>
                        </div>
                        <div className="col-md-6 col-lg-12 col-sm-6">
                          <div className="slide-image-container right-image d-flex align-items-center">
