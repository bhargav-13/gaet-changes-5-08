            ...
            <div className='inner-content-wapper'>
                <div className='two-photo-area'>
                    <div className='left-part'>
                        ...
                        <div className='content-block'>
                            <ScrollAnimation animateIn="fadeInUp" animateOnce={true} delay={500}>
                                <h2><span dangerouslySetInnerHTML={{ __html: data.online_admission[0].title }} /></h2>
                                <Link to={data.online_admission[0].link} className='common-button-more cyan'>Click Here</Link>
                            </ScrollAnimation>
                        </div>
                    </div>
                    <div className='right-part'>
                        ...
                        <div className='content-block'>
                            <ScrollAnimation animateIn="fadeInUp" animateOnce={true} delay={500}>
                                <h2><span dangerouslySetInnerHTML={{ __html: data.online_admission[1].title }} /></h2>
                                <Link to={data.online_admission[1].link} className='common-button-more cyan'>Click Here</Link>
                            </ScrollAnimation>
                        </div>
                    </div>
                    <div className='full-part'>
                        ...
                        <div className='center-content'>
                            <ScrollAnimation animateIn="fadeInUp" animateOnce={true} delay={500}>
                                <p><span dangerouslySetInnerHTML={{ __html: data.contact_us[0].title }} /></p>

                                <Link to={data.contact_us[0].link} className='common-button-more blue'>Contact Us</Link>
                            </ScrollAnimation>
                        </div>
